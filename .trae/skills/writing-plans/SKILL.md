---
name: "writing-plans"
description: "Use when you have a spec or requirements for a multi-step task, before touching code. Outputs a bite-sized step-by-step implementation plan."
---
...
**"Plan complete and saved to `docs/plans/<filename>.md`. Ready to execute using the executing-plans skill?"**
